# ruff: noqa: SLF001, ANN001, ANN003, ANN201, PLR2004, FBT001, FBT002, INP001
# Local, git-ignored test helper (the `tests` directory is excluded from version control). The exempted rules are the
# standard test-code patterns (private-method access, fixtures, magic values) a repo would normally relax via tracked
# per-file ruff ignores; since this file is git-ignored, the exemption is kept confined to it.
